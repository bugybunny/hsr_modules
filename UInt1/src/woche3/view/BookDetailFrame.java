 ...
 * @author msyfrig
 */
public class BookDetailFrame extends JFrame implements Observer {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    BookDetailFrame frame = new BookDetailFrame();
    ...
    public BookDetailFrame(BookDO aBookDo) {
        this();
        setBookDO(aBookDo);
    }
    ...
    public BookDetailFrame() {
        ...
        for (BookConditionEnum tempBookCondition : BookConditionEnum.values()) {
            comboBox.addItem(tempBookCondition.toString());
        }
    ...
    private void updateDisplay() {
        if (displayedBookDO == null) {
            ...
            isbnTextfield.setText(displayedBookDO.getIsbn());
